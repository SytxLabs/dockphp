...
/**
 * In-memory fake used to unit-test Resources without a real Docker
 * socket. Records every call and returns pre-configured responses;
 * stream()/streamRaw() replay a canned list of chunks through the
 * caller's $onChunk callback.
 */
final class FakeDockerTransport implements DockerTransportInterface
{
    ...
    public function __construct(
        private DockerResponse $response = new DockerResponse(200, '{}'),
