...
final class DockerTransportTcpTest extends TestCase
{
    ...
    {
        $transport = TestableDockerTransport::forTcp('docker.example.com', apiVersion: '1.43');
        self::assertSame('http://docker.example.com:2375/containers/json', $transport->publicBuildUrl('/containers/json', []));
    }
    ...
    public function testBuildUrlUsesHttpsWhenTlsEnabled(): void
    {
        ...
        self::assertSame('https://docker.example.com:2376/containers/json', $transport->publicBuildUrl('/containers/json', []), );
    }

    public function testBuildUrlUsesCustomPort(): void
    {
        $transport = TestableDockerTransport::forTcp('10.0.0.5', 9999, apiVersion: '1.43');
        self::assertSame('http://10.0.0.5:9999/info', $transport->publicBuildUrl('/info', []));
    }
    ...
    public function testForSocketStillUsesLocalhostBase(): void
    {
        ...
        self::assertSame('http://localhost/info', $transport->publicBuildUrl('/info', []));
    }
}
