...
final class DockerApiExceptionTest extends TestCase
{
    ...
    {
        $exception = DockerApiException::fromResponse('GET', '/containers/abc/json', 500, '{"message":"something went wrong"}');
    ...
    {
        $exception = DockerNotFoundException::fromResponse('GET', '/containers/missing/json', 404, '{"message":"No such container: missing"}');
